...
$message = '<table cellspacing="0" cellpadding="0" border="0" style="width:620px"> 
       ...
       <tr style="border:1x solid #ddd">
         ...
         <td width="456" style="font-size:20px;border:1x solid #ddd">'. $n .'</td>
       </tr>
        <tr style="border:1x solid #ddd">
	    ...
	    <tr style="border:1x solid #ddd">
         <td height="26" valign="top" style="font-size:20px;border:1x solid #ddd;padding-left:80px"><strong>Country :</strong></td>
         <td style="font-size:20px;border:1x solid #ddd">'. $c.'</td>
       </tr>
	   
	     <tr style="border:1x solid #ddd">
         <td height="26" valign="top" style="font-size:20px;border:1x solid #ddd;padding-left:80px"><strong>Products :</strong></td>
         <td style="font-size:20px;border:1x solid #ddd">'. $g.' '. $m.' '. $t.' '. $p.' '. $pc.' '. $go.'</td>
       </tr>
	   <tr style="border:1x solid #ddd">
...
echo ("<SCRIPT LANGUAGE='JavaScript'>
  ...
  window.location.href='https://biz4u.sg/thank-you.html';
  </SCRIPT>");
